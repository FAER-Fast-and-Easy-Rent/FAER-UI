          ...
          <div className=" mx-auto max-w-md rounded-lg border bg-gray-50 p-12 shadow dark:border-gray-900 dark:bg-gray-900/60">
            ...
            >
              ...
              <div className="flex justify-center pt-4">
                <button className="rounded-full border border-gray-800 px-8 py-2 text-sm text-gray-700 transition-all hover:bg-gray-100 hover:text-black dark:text-white sm:text-base">
                  Login
                </button>
              </div>
